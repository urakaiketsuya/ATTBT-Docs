---
 title: BP_Action_ShowSelection
 slug: BP_Action_ShowSelection
 date: "2024-09-28"
 description: " Shows that an actor has been selected by the player or AI. Calls on the GridCamera to follow the actor and calls on the GridUI to mark the actor (by default displaying an active unit marker below the actor)"
---
