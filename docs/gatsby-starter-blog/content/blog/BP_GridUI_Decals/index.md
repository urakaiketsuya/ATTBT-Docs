---
 title: BP_GridUI_Decals
 slug: BP_GridUI_Decals
 date: "2024-09-28"
 description: "None."
---
...
Path: /Game/AdvancedTurnBasedTileToolkit/Core/GridUI/BP_GridUI_Decals

.. cpp:class:: BP_GridUI_Decals : public BP_GridUI_C
   ...
   .. cpp:function:: exec SpawnTileMarkers(exec then, ETileMarkerType MarkerType=NewEnumerator0, Vector Locations)
      ...
      :arg then: 
      :type then: exec
      :arg MarkerType: Marker Type ETileMarkerType Enum (Default: NewEnumerator0)
      :type MarkerType: ETileMarkerType
      :arg Locations: Locations Array of Vectors
      :type Locations: Vector
      :returns execute: 
      :rtype execute: exec

   .. cpp:function:: exec ClearTileMarkers(exec then, ETileMarkerType MarkerType=NewEnumerator0)
   ...
   .. cpp:member:: DecalComponent ActiveActorMarkerDecal
   ...
   .. cpp:member:: DecalComponent TargetMarkerDecal
   ...
   .. cpp:member:: DecalComponent HoverMarkerDecal
   ...
   .. cpp:member:: double UE5DecalScaleFactor
