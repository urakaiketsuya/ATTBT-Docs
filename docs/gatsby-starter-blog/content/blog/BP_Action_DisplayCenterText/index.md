---
 title: BP_Action_DisplayCenterText
 slug: BP_Action_DisplayCenterText
 date: "2024-09-28"
 description: " Displays the specified text in large letters in the center of the screen on WBP_ATBTT for a specified duration. By default used to display faction turns when using the Strategy Turn Manager"
---

BP_Action_DisplayCenterText
============================

Path: /Game/AdvancedTurnBasedTileToolkit/Core/Actions/BP_Action_DisplayCenterText

.. cpp:class:: BP_Action_DisplayCenterText : public BP_Action_C
   ...
   .. cpp:member:: bool bPauseActionsForDelay
