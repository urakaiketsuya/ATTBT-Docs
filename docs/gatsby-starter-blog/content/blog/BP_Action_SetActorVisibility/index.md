---
 title: BP_Action_SetActorVisibility
 slug: BP_Action_SetActorVisibility
 date: "2024-09-28"
 description: " Sets the specified actor to HiddenInGame (or disables this)"
---

BP_Action_SetActorVisibility
=============================

Path: /Game/AdvancedTurnBasedTileToolkit/Core/Actions/BP_Action_SetActorVisibility

.. cpp:class:: BP_Action_SetActorVisibility : public BP_Action_C
