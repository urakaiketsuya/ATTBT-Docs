---
 title: BP_Action_DisplayStatusEffect
 slug: BP_Action_DisplayStatusEffect
 date: "2024-09-28"
 description: " Displays a status effect icon on the Unit HUD of the specified puppet"
---

BP_Action_DisplayStatusEffect
==============================

Path: /Game/AdvancedTurnBasedTileToolkit/Core/Actions/BP_Action_DisplayStatusEffect

.. cpp:class:: BP_Action_DisplayStatusEffect : public BP_Action_C
   ...
   .. cpp:member:: Actor Puppet
      ...
      Access Modifier: 
      Flags: Edit, Blueprint Visible, Net, Zero Constructor, Disable Edit On Template, Interp, No Destructor, Expose On Spawn, Has Get Value Type Hash
      Lifetime Condition: None
