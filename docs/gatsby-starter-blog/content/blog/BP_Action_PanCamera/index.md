---
 title: BP_Action_PanCamera
 slug: BP_Action_PanCamera
 date: "2024-09-28"
 description: " Calls on the grid camera to pan to the specified location"
---

BP_Action_PanCamera
====================

Path: /Game/AdvancedTurnBasedTileToolkit/Core/Actions/BP_Action_PanCamera

.. cpp:class:: BP_Action_PanCamera : public BP_Action_C
