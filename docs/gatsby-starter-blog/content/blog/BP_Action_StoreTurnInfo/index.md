---
 title: BP_Action_StoreTurnInfo
 slug: BP_Action_StoreTurnInfo
 date: "2024-09-28"
 description: " Stores the Current Turn and Active Actor in special Animate variables in the Turn Manager. Useful if you need to know what turn and active actor is currently being displayed to the player (the actual current turn and active actor might be different, since the action system is asynchronous and can lag behind)"
---

BP_Action_StoreTurnInfo
========================

Path: /Game/AdvancedTurnBasedTileToolkit/Core/Actions/BP_Action_StoreTurnInfo

.. cpp:class:: BP_Action_StoreTurnInfo : public BP_Action_C
