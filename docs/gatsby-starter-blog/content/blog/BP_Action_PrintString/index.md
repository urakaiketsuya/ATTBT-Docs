---
 title: BP_Action_PrintString
 slug: BP_Action_PrintString
 date: "2024-09-28"
 description: " For printing strings as part of the action queue. For debugging."
---

BP_Action_PrintString
======================

Path: /Game/AdvancedTurnBasedTileToolkit/Core/Actions/BP_Action_PrintString

.. cpp:class:: BP_Action_PrintString : public BP_Action_C
   ...
   .. cpp:member:: String InString

      Category: Default

      Access Modifier: 
      Flags: Edit, Blueprint Visible, Net, Zero Constructor, Expose On Spawn, Has Get Value Type Hash
      Lifetime Condition: None

      

   .. cpp:member:: bool bPrintToScreen
   ...
   .. cpp:member:: LinearColor TextColor
